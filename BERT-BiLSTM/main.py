...
class Niubility:
    ...
    def run(self):
        ...
        # Initialize a list to save the results in each epoch
        results = []
        ...
        for epoch in range(self.args.num_epoch):
            ...
            try:
                ...
                self.logger.error(f'Failed to save model at epoch {epoch + 1}: {e}')
            ...
            try:
                results_df.to_csv(f'training_results_epoch{epoch + 1}.csv', index=False)
            except:
                pass
